...
def _build_vision_tower(
    ...
    if vision_cfg.timm_model_name:
        ...
        visual = V2VTransformer(
            ...
            prompt_length=vision_cfg.prompt_length,
            prompt_depth=vision_cfg.prompt_depth,
        )
    print("Visual Tower:", visual.__class__.__name__)
    return visual
...
def _build_text_tower(
    ...
    print("Text Tower:", text.__class__.__name__)
    return text
...
class CLIP(nn.Module):
    ...
    def encode_image(self, image, all_prompts=None, missing_type=None, normalize: bool = False):
        if missing_type is not None:
            features = self.visual(image, all_prompts, missing_type)
        else:
