...
def get_dir_from_args(TASK, root_dir, **kwargs):
    ...
    csv_dir = os.path.join(root_dir, f'{dataset}', f'{missing_type}', f'{missing_rate}', 'csv')
    check_dir = os.path.join(root_dir, f'{dataset}', f'{missing_type}', f'{missing_rate}', 'checkpoint')
    img_dir = os.path.join(root_dir, f'{dataset}', f'{missing_type}', f'{missing_rate}', 'imgs')
